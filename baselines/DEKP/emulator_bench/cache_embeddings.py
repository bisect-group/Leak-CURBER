...
DEFAULT_DATASET_DF_PATH = Path(os.environ.get("PROJECT_ROOT", ".")) / "data" / "processed" / "baselines" / "DEKP" / "km_kinetic_params_3d.parquet"
...
def main():
    parser = argparse.ArgumentParser(description="Build reusable DEKP caches for Leak-CURBER split retraining.")
